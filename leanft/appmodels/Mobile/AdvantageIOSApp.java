...
public class AdvantageIOSApp extends AppModelBase {		private AdvantageShoppingApplication AdvantageShoppingApplication;
	...
	public class ConfirnPasswordSignUpEditField extends EditFieldNodeBase
	{
								...
								public ConfirnPasswordSignUpEditField(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			...
			setDisplayName("ConfirnPasswordSignUpEditField");
		}
		...
		protected com.hp.lft.sdk.mobile.EditFieldDescription createDescription() throws GeneralLeanFtException{
			com.hp.lft.sdk.mobile.EditFieldDescription description = null; 
			try{
				description = new com.hp.lft.sdk.mobile.EditFieldDescription.Builder().accessibilityId("confirmPasswordTextFielD").className("Input").mobileCenterIndex(1).build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class UserNameSignUpEditField extends EditFieldNodeBase
	{
		...
		protected com.hp.lft.sdk.mobile.EditFieldDescription createDescription() throws GeneralLeanFtException{
			com.hp.lft.sdk.mobile.EditFieldDescription description = null; 
			try{
				description = new com.hp.lft.sdk.mobile.EditFieldDescription.Builder().className("Input").mobileCenterIndex(0).accessibilityId("userNameTextFieldID").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class AdvantageShoppingApplication1 extends ApplicationNodeBase
	{
		...
		protected com.hp.lft.sdk.mobile.ApplicationDescription createDescription() throws GeneralLeanFtException{
			com.hp.lft.sdk.mobile.ApplicationDescription description = null; 
			try{
				description = new com.hp.lft.sdk.mobile.ApplicationDescription.Builder().identifier("com.Advantage.iShopping").packaged(false).build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
