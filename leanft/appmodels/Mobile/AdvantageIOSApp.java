...
public class AdvantageIOSApp extends AppModelBase {		private IshoppingApplication IshoppingApplication;
	...
	private QuantityEditField QuantityEditField;
	...
	private AddProductMessageOkButton AddProductMessageOkButton;
		...
		QuantityEditField = new QuantityEditField(this, applicationModel);
		...
		public QuantityEditField QuantityEditField() { return QuantityEditField; }
	...
	public class TABLETSLabel extends LabelNodeBase
	{
		...
		protected com.hp.lft.sdk.mobile.LabelDescription createDescription() throws GeneralLeanFtException{
			com.hp.lft.sdk.mobile.LabelDescription description = null; 
			try{
				description = new com.hp.lft.sdk.mobile.LabelDescription.Builder().text("TABLETS").accessibilityId("TABLETS").className("Label").container("Table[0][2][0]").mobileCenterIndex(0).build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class QuantityEditField extends EditFieldNodeBase
	{

		
								public QuantityEditField(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);

			
			setDisplayName("QuantityEditField");
		}
