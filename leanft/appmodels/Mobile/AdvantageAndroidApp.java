...
public class AdvantageAndroidApp extends AppModelBase {		private AdvantageShoppingApplication AdvantageShoppingApplication;
	...
	private AdvantageShoppingApplication1 AdvantageShoppingApplication1;
	...
	public AdvantageAndroidApp(TestObject contextTestObject) throws GeneralLeanFtException
	{
		...
		AdvantageShoppingApplication1 = new AdvantageShoppingApplication1(contextTestObject, this);
		...
		public AdvantageShoppingApplication1 AdvantageShoppingApplication1() { return AdvantageShoppingApplication1; }
	...
	private InvalidUserNameOrPas InvalidUserNameOrPas;
	...
	private ShippingDetailsFirstNameEditField ShippingDetailsFirstNameEditField;
		...
		InvalidUserNameOrPas = new InvalidUserNameOrPas(this, applicationModel);
		...
		public InvalidUserNameOrPas InvalidUserNameOrPas() { return InvalidUserNameOrPas; }
	...
	public class SPEAKERSLabel extends MobileLabelNodeBase
	{
	...
	public class TABLETSLabel extends MobileLabelNodeBase
	{
	...
	public class MICELabel extends MobileLabelNodeBase
	{
	...
	public class HEADPHONESLabel extends MobileLabelNodeBase
	{
	...
	public class MainMenu extends MobileUiObjectNodeBase
	{
	...
	public class UserNameEdit extends MobileEditFieldNodeBase
	{
	...
	public class PassEdit extends MobileEditFieldNodeBase
	{
	...
	public class LOGINButton extends MobileButtonNodeBase
	{
	...
	public class DonTHaveAnAccountLabel extends MobileLabelNodeBase
	{
	...
	public class SIGNOUTLabel extends MobileLabelNodeBase
	{
	...
	public class YESButton extends MobileButtonNodeBase
	{
	...
	public class Login extends MobileLabelNodeBase
	{
	...
	public class CartAccess extends MobileUiObjectNodeBase
	{
	...
	public class LaptopItem extends MobileUiObjectNodeBase
	{
	...
	public class ADDTOCARTButton extends MobileButtonNodeBase
	{
	...
	public class ProductQuantity extends MobileUiObjectNodeBase
	{
	...
	public class ProductColor extends MobileUiObjectNodeBase
	{
	...
	public class ProductDetail extends MobileUiObjectNodeBase
	{
	...
	public class LaptopItem2 extends MobileUiObjectNodeBase
	{
	...
	public class colorObject extends MobileUiObjectNodeBase
	{
	...
	public class APPLYChangeLabel extends MobileLabelNodeBase
	{
	...
	public class CHECKOUT extends MobileButtonNodeBase
	{
	...
	public class ScrollViewCartProducts extends MobileViewNodeBase
	{
	...
	public class PAYNOWButton extends MobileButtonNodeBase
	{
	...
	public class SaveSafePayCredentialsCheckBox extends MobileCheckBoxNodeBase
	{
	...
	public class UserNameSignUp extends MobileEditFieldNodeBase
	{
	...
	public class REGISTERButton extends MobileButtonNodeBase
	{
	...
	public class ImageViewSafePay extends MobileUiObjectNodeBase
	{
	...
	public class ImageViewMasterCredit extends MobileUiObjectNodeBase
	{
	...
	public class SafePayUserfieldEditField extends MobileEditFieldNodeBase
	{
	...
	public class SafePayPassFieldEditField extends MobileEditFieldNodeBase
	{
	...
	public class PaymentDetails extends MobileUiObjectNodeBase
	{
	...
	public class HOMELabel extends MobileLabelNodeBase
	{
	...
	public class QuantityLabel extends MobileLabelNodeBase
	{
	...
	public class UPDATEPRODUCTButton extends MobileButtonNodeBase
	{
	...
	public class VerifyReceiptWindowUiObject extends MobileUiObjectNodeBase
	{
	...
	public class CartQuantityLabel extends MobileLabelNodeBase
	{
	...
	public class FirstCartItem extends MobileUiObjectNodeBase
	{
	...
	public class CartRemove extends MobileUiObjectNodeBase
	{
	...
	public class AccountDetails extends MobileUiObjectNodeBase
	{
	...
	public class tabletItem extends MobileUiObjectNodeBase
	{
	...
	public class ProductQuantityEditField extends MobileEditFieldNodeBase
	{
	...
	public class LoginObj extends MobileUiObjectNodeBase
	{
	...
	public class ChangePasswordLabel extends MobileLabelNodeBase
	{
	...
	public class OldPassEditField extends MobileEditFieldNodeBase
	{
	...
	public class NewPassEditField extends MobileEditFieldNodeBase
	{
	...
	public class ConfirmNewPassEditField extends MobileEditFieldNodeBase
	{
	...
	public class UPDATEAccountButton extends MobileButtonNodeBase
	{
	...
	public class ImageViewFilter extends MobileUiObjectNodeBase
	{
	...
	public class BYMANUFACTURERLabel extends MobileLabelNodeBase
	{
	...
	public class HPLabel extends MobileLabelNodeBase
	{
	...
	public class SOLDout extends MobileLabelNodeBase
	{
	...
	public class LaptopFilter2UiObject extends MobileUiObjectNodeBase
	{
	...
	public class EditShippingUiObject extends MobileUiObjectNodeBase
	{
	...
	public class CVVMasterCreditEditField extends MobileEditFieldNodeBase
	{
	...
	public class MonthMasterCreditLabel extends MobileLabelNodeBase
	{
	...
	public class YEARMasterCreditLabel extends MobileLabelNodeBase
	{
	...
	public class ConfirmPassSignUp extends MobileEditFieldNodeBase
	{
	...
	public class EmailSignUp extends MobileEditFieldNodeBase
	{
	...
	public class PasswordSignUp extends MobileEditFieldNodeBase
	{
	...
	public class SignUp extends MobileUiObjectNodeBase
	{
	...
	public class HOME extends MobileLabelNodeBase
	{
	...
	public class SETTINGSLabel extends MobileLabelNodeBase
	{
	...
	public class EditTextServer extends MobileEditFieldNodeBase
	{
	...
	public class ContentPanelConnection extends MobileUiObjectNodeBase
	{
	...
	public class OKButton extends MobileButtonNodeBase
	{
		...
		protected com.hp.lft.sdk.mobile.ButtonDescription createDescription() throws GeneralLeanFtException{
			com.hp.lft.sdk.mobile.ButtonDescription description = null; 
			try{
				description = new com.hp.lft.sdk.mobile.ButtonDescription.Builder().text("OK").className("Button").resourceId("button1").mobileCenterIndex(2).build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class InvalidUserNameOrPas extends MobileLabelNodeBase
	{

		
								public InvalidUserNameOrPas(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
		...
		protected com.hp.lft.sdk.mobile.LabelDescription createDescription() throws GeneralLeanFtException{
			com.hp.lft.sdk.mobile.LabelDescription description = null; 
			try{
				description = new com.hp.lft.sdk.mobile.LabelDescription.Builder().text("Invalid user name or password").className("Label").resourceId("textViewFailed").mobileCenterIndex(2).build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class SignUPtUiObject extends MobileUiObjectNodeBase
	{
	...
	public class ButtonPanelSettingUiObject extends MobileUiObjectNodeBase
	{
	...
	public class SignUpObject extends MobileUiObjectNodeBase
	{
	...
	public class ChangePasswordObject extends MobileUiObjectNodeBase
	{
	...
	public class LaptopitemWin10 extends MobileUiObjectNodeBase
	{
	...
	public class CardHolderMasterCreditEditField extends MobileEditFieldNodeBase
	{
	...
	public class AdvantageObjectUiObject extends MobileUiObjectNodeBase
	{
	...
	public class ZIPmyAccauntEditField extends MobileEditFieldNodeBase
	{
	...
	public class CardNumderMasterCreditEditField extends MobileEditFieldNodeBase
	{
	...
	public class SaveMasterCreditCredenCheckBox extends MobileCheckBoxNodeBase
	{
	...
	public class ShippingCheckBox extends MobileCheckBoxNodeBase
	{
	...
	public class ZIPshippingDetaildEditField extends MobileEditFieldNodeBase
	{
	...
	public class StateSignUpEditField extends MobileEditFieldNodeBase
	{
	...
	public class AddressSignUpEditField extends MobileEditFieldNodeBase
	{
	...
	public class CitySignUpEditField extends MobileEditFieldNodeBase
	{
	...
	public class ZIPSignUpEditField extends MobileEditFieldNodeBase
	{
	...
	public class BYOPERATINGSYSTEMLabel extends MobileLabelNodeBase
	{
	...
	public class Windows10Label extends MobileLabelNodeBase
	{
	...
	public class CARTLabel extends MobileLabelNodeBase
	{
	...
	public class CloseDialog extends MobileUiObjectNodeBase
	{
	...
	public class LinearLayoutLogin extends MobileUiObjectNodeBase
	{
	...
	public class ServerNotReachableLabel extends MobileLabelNodeBase
	{
	...
	public class DonTHaveAnAccount extends MobileLabelNodeBase
	{
	...
	public class YouAreNotConnectedToLabel extends MobileLabelNodeBase
	{
	...
	public class NoteOfflineModLabel extends MobileLabelNodeBase
	{
	...
	public class WarningMessageUiObject extends MobileUiObjectNodeBase
	{
	...
	public class LoggedUserName extends MobileLabelNodeBase
	{
	...
	public class ApplyButton extends MobileButtonNodeBase
	{
	...
	public class SignedInUserName extends MobileLabelNodeBase
	{
	...
	public class ShippingDetailsFirstNameEditField extends MobileEditFieldNodeBase
	{
	...
	public class SettingsConnections extends MobileLabelNodeBase
	{
	...
	public class ConnectionsAirplaneModeToggle extends MobileToggleNodeBase
	{
	...
	public class AdvantageShoppingApplication1 extends MobileApplicationNodeBase
	{
	...
	public abstract class MobileLabelNodeBase extends AppModelNodeBase<com.hp.lft.sdk.mobile.Label, com.hp.lft.sdk.mobile.LabelDescription> implements com.hp.lft.sdk.mobile.Label
	{		
		public MobileLabelNodeBase(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
		}
	...
	public abstract class MobileUiObjectNodeBase extends AppModelNodeBase<com.hp.lft.sdk.mobile.UiObject, com.hp.lft.sdk.mobile.UiObjectDescription> implements com.hp.lft.sdk.mobile.UiObject
	{		
		public MobileUiObjectNodeBase(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
		}
	...
	public abstract class MobileEditFieldNodeBase extends AppModelNodeBase<com.hp.lft.sdk.mobile.EditField, com.hp.lft.sdk.mobile.EditFieldDescription> implements com.hp.lft.sdk.mobile.EditField
	{		
		public MobileEditFieldNodeBase(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
		}
	...
	public abstract class MobileButtonNodeBase extends AppModelNodeBase<com.hp.lft.sdk.mobile.Button, com.hp.lft.sdk.mobile.ButtonDescription> implements com.hp.lft.sdk.mobile.Button
	{		
		public MobileButtonNodeBase(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
		}
	...
	public abstract class MobileViewNodeBase extends AppModelNodeBase<com.hp.lft.sdk.mobile.View, com.hp.lft.sdk.mobile.ViewDescription> implements com.hp.lft.sdk.mobile.View
	{		
		public MobileViewNodeBase(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
		}
	...
	public abstract class MobileCheckBoxNodeBase extends AppModelNodeBase<com.hp.lft.sdk.mobile.CheckBox, com.hp.lft.sdk.mobile.CheckBoxDescription> implements com.hp.lft.sdk.mobile.CheckBox
	{		
		public MobileCheckBoxNodeBase(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
		}
	...
	public abstract class MobileToggleNodeBase extends AppModelNodeBase<com.hp.lft.sdk.mobile.Toggle, com.hp.lft.sdk.mobile.ToggleDescription> implements com.hp.lft.sdk.mobile.Toggle
	{		
		public MobileToggleNodeBase(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
		}
